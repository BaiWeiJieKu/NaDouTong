...
public class UpdateDriver {
		 ...
		 */
		@RequestMapping(value = "/uploadDriver",method = { RequestMethod.POST,RequestMethod.GET})  
		@ResponseBody
	    public JsonData DriverCard(HttpServletRequest request, HttpServletResponse response) throws IOException {  
			MultipartHttpServletRequest req =(MultipartHttpServletRequest)request;
			MultipartFile multipartFile =  req.getFile("uploadfile_ant2"); //对应前端页面的name值
	        ...
	        mobileregistry.setDrivercard("/image/"+picName);
	        JsonData json=mobileregistryservice.updateDriverCard(mobileregistry);
	        return json;
