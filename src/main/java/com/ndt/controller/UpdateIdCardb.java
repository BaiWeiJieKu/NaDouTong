...
public class UpdateIdCardb {
		 ...
		 */
		@RequestMapping(value = "/uploadIdcardb", method = { RequestMethod.POST,RequestMethod.GET})  
		@ResponseBody
	    public JsonData IdcardB(HttpServletRequest request, HttpServletResponse response) throws IOException {  
			MultipartHttpServletRequest req =(MultipartHttpServletRequest)request;
			MultipartFile multipartFile =  req.getFile("uploadfile_ant4"); //对应前端页面的name值
	        ...
	        mobileregistry.setIdcardb("/image/"+picName);
	        JsonData json=mobileregistryservice.updateIdcardB(mobileregistry);
	        return json;
